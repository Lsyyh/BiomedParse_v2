...
class BoltzFormerTextDecoder(nn.Module):
    ...
    def forward(
        ...
        outputs_mask, attn_mask, outputs_caption = (
        ...
        predictions_captions.append(outputs_caption)
        ...
        out = {
            ...
            "pred_captions": predictions_captions[-1],
        }
        if self.output_classifier:
            out["object_existence"] = self.classifier(cls_output[0])
        return out
    ...
    def forward_prediction_heads(
        ...
        # Visual embedding for query-text matching (v1 compatibility) !!!
        ...
        return outputs_mask, attn_mask, class_embed
